                                        ...
                                        <div className="col-lg-4">
											<div className="form-group">
                                                <select className='form-control'>
                                                    ...
                                                    <option value="1">XR Training</option>
                                                    <option value="2">Simulator</option>
                                                    <option value="3">Quiz Box</option>
                                                    <option value="4">EHS</option>
                                                    <option value="5">Remote Assist</option>
                                                    <option value="6">Refelexes</option>
                                                </select>
											</div>
										</div>
