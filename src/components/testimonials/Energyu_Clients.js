...
export class Energyu_Clients extends Component {
    state={
        options : {
            margin: 50,
            dots:false,
                  ...
                  <div className="row">
                      <div className="col-md-12">
                        <div className="testimonialssec">
                            <h3 className='text-center'>Trusted by <span>Energy and Utilities</span> Company</h3>
...
export default Energyu_Clients