...
const Blogs = () => {
    ...
    //  const [xr,setXR]= useState("XR")
    //  const [sm,setSM]= useState("SM")
    //  const [qz,setQZ]= useState("QZ")
   ...
   const XRTraining =()=>{
     number != "" ? setNumber("2") : setNumber("3");
     xr == "XR" ? setXr("") : setXr("XR");
  ...
  return (
    <>
        ...
        <div className="widget recent-posts-entry">
            ...
            <div className="widget recent-posts-entry">
                <h6 className="widget-title">Industry</h6>
                <div>
                    <div class="form-check"  >
