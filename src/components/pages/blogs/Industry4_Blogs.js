...
export class Industry4_Blogs extends Component {
  render() {
    ...
    return (
      <>
          <Helmet>  
            <title>Industry 4.0 and use of AR, VR & MR along with IoT</title> 
         ...
         <div className="page-content">
            <div className="page-banner ovbl-dark parallax" style={{backgroundImage: "url("+Banner1+")"}}>
              <Breadcrumb heading="Industry 4.0 " title="Industry 4.0 " />
            </div>
                                    ...
                                    <div className="blog-lg blog-single">
                                        ...
                                        <div className="info-bx">
                                            <div className="ttr-post-title">
                                                <h4 className="post-title">Industry 4.0 and use of AR, VR & MR along with IoT</h4>
                                            </div>
                                            <div className="ttr-post-text">
                                                ...
                                                <p>The report goes on to say, “Digital transformation, new business models and Industry 4.0 require new ways of thinking, of working, of cooperating and ultimately of training personnel.” Well, certainly there would be a need to train the personnel on security parameters and industry advancements. At the same time there is ample opportunity with how the things are progressing in Industry 4.0 era, wherein the employees would have the chance to stay abreast with the latest regulations, constantly enhancing process know-how, and safety parameters. Virtual reality, Augmented Reality and Mixed Reality can be that bridge which connects the personnel with the Industry 4.0 advancements while utilizing the IoT developments effectively, and skilling the personnel would become relatively easy, efficient and cost-effective.  </p>
                                                <h4>To give a brief account of how AR, VR and MR are placed, this image will give a better understanding:</h4>
...
export default Industry4_Blogs