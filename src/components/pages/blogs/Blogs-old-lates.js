...
import Banner1 from '../../../assets/images/blog/vrfuture.jpg';
     ...
     changeType=(e)=>{
        ...
        current.setState({
          item:this.state.posts.map((item,index)=>{
            if(item.product === e ){
              item.type === e ? item.type = "" : item.type = e ;  
              }
              return item;
            })   
          })
      
          if(current.state.allTag.includes(e)){
            var myArray = current.state.allTag;
            myArray = myArray.filter(value => value !== e);
            current.setState({ allTag:myArray  })
          }else{
            current.setState({ allTag: [...this.state.allTag, e] })
          }
        }
                                              ...
                                              <Accordion.Body>
                                                    ...
                                                    <div className="widget recent-posts-entry">
                                                      <div className="form-check" >
                                                          <input className="form-check-input" onClick={()=>this.changeType("xr")} type="checkbox" value="" id="10" />
                                                          <label className="form-check-label" htmlFor="10">
                                                              XR Training
                                                          </label>
                                                      </div>
                                                      <div className="form-check" >
                                                          <input className="form-check-input" onClick={()=>this.changeType("sm")} type="checkbox" value="" id="11" />
                                                          <label className="form-check-label" htmlFor="11">
                                                              Simulator 
                                                          </label>
                                                      </div>
                                                      <div className="form-check">
                                                          <input className="form-check-input"  onClick={()=>this.changeType("qz")} type="checkbox" value="" id="12" />
                                                          <label className="form-check-label" htmlFor="12">
                                                              Quizbox
                                                          </label>
                                                      </div>
                                                      <div className="form-check" >
                                                          <input className="form-check-input" onClick={()=>this.changeType("rm")} type="checkbox" value="" id="13" />
                                                          <label className="form-check-label" htmlFor="13">
                                                              Remote Assistance
                                                          </label>
                                                      </div>
                                                      <div className="form-check" >
                                                          <input className="form-check-input" onClick={()=>this.changeType("rf")} type="checkbox" value="" id="14" />
                                                          <label className="form-check-label" htmlFor="14">
                                                              Reflexis
                                                          </label>
                                                      </div>
                                                      <div className="form-check" >
                                                          <input className="form-check-input" onClick={()=>this.changeType("sn")} type="checkbox" value="" id="15" />
                                        ...
                                        <Accordion.Header><h6 className="widget-title">Industry </h6></Accordion.Header>
                                          <Accordion.Body>
                                              ...
                                              <div className="widget recent-posts-entry">
                                                  <div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Pharmaceutical")} type="checkbox" value="" id="1" />
                                                          <label className="form-check-label" htmlFor="1">
                                                              Pharmaceutical
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Automotive")} type="checkbox" value="" id="2" />
                                                          <label className="form-check-label" htmlFor="2">
                                                              Automotive
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Automation")} type="checkbox" value="" id="3" />
                                                          <label className="form-check-label" htmlFor="3">
                                                              Automation
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("OilGas")} type="checkbox" value="" id="4" />
                                                          <label className="form-check-label" htmlFor="4">
                                                              Oil & Gas
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Fmcg")} type="checkbox" value="" id="5" />
                                                          <label className="form-check-label" htmlFor="5">
                                                              FMCG
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("EnergyUtilities")} type="checkbox" value="" id="6" />
                                                          <label className="form-check-label" htmlFor="6">
                                                              Energy and Utilities
                                                          </label>
                                                      </div>
                                                      <div className="form-check"   >
                                                          <input className="form-check-input" onClick={() => this.changeType("Paintchemicals")} type="checkbox" value="" id="7" />
                                                          <label className="form-check-label" htmlFor="7">
                                                              Paint and Chemicals
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Construction")} type="checkbox" value="" id="8" />
                                                          <label className="form-check-label" htmlFor="8">
                                                              Construction
                                                          </label>
                                                      </div>
                                                      <div className="form-check"  >
                                                          <input className="form-check-input" onClick={() => this.changeType("Engineering")} type="checkbox" value="" id="9" />
