...
import case1 from '../../../assets/images/case_study/injection.jpg';
import case2 from '../../../assets/images/case_study/welding.jpg';
import case3 from '../../../assets/images/case_study/pharmacase.jpg';

export class InjectionMoulding extends Component {
  render() {
      ...
      <>
         ...
         <div className="page-content">
            <div className="page-banner ovbl-dark parallax" style={{backgroundImage: "url("+Banner1+")"}}>
              <Breadcrumb heading="Injection Moulding" title="Injection Moulding" />
            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-7">
                            ...
                            <h4>Process</h4>
                            <p>Material for the part is fed into a heated barrel, mixed using a helical shaped screw, and injected into a mould cavity, where it cools and hardens to the configuration of the cavity.</p>
                            <h4>Application</h4>
                            <p>Injection moulding can be performed with a host of materials mainly metals, glasses, elastomers, confections, and most commonly thermoplastic and thermosetting polymers. It is used to create many things such as wire spools, packaging, bottle caps, automotive dashboards, pocket combs, and most other plastic products available today. It is ideal for producing high volumes of the same object.</p>
                            <h4>Problem</h4>
                            <p>Material for the part is fed into a heated barrel, mixed using a helical shaped screw, and injected into a mould cavity, where it cools and hardens to the configuration of the cavity.</p>
                            <h4>Root cause</h4>
                            ...
                            <h4>What We Did</h4>
                            <p>Having expertise over years in terms of creating exceptional VR solutions in the manufacturing sector. Our subject matter experts went to the site and closely worked with the site team to understand the different nuances of the process to deliver a PC based VR training module to gamify each operating steps in-line with standard SOP.</p>
                            ...
                            <h4 className='mt-3'>Viable Scope</h4>
                            <p>Gamify injection moulding and make the user well verse with its insights, operations involved in the process with the help of modelling and animations of a real-like scenario of any industry in virtual reality.</p>
                            <p>The standard operating procedures involved during the production of different parts using injection moulding machine in various industries can be simulated along with in-built analytics in the virtual real-like environment of the actual job floor through which the operator will perform the procedures by himself, just as he may enact at the job floor. Also the user will get to know the errors and mistakes he may have made during the process and would not repeat them again.</p>
                            <h4>Feedback</h4>
